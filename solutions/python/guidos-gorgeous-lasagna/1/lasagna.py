...
def preparation_time_in_minutes(num_of_layers):
    """Calculate the total preparation time needed in minutes for given number of layers
    
    :param num_of_layers: int - the number of layers in the lasagna
    :return: int - the total prepration time needed in minutes"""
    return num_of_layers * PREPARATION_TIME


#TODO: define the 'elapsed_time_in_minutes()' function below.
def elapsed_time_in_minutes(num_of_layers, elapsed_bake_time):
    """Total time spent in the kitchen till now cooking (preparing + cooking)
    
    :param: int - num_of_layers: int number of layers in lasagna
